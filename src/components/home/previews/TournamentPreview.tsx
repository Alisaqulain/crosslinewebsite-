...
export function TournamentPreview({ tournaments }: { tournaments: Tournament[] }) {
  const upcoming = tournaments.filter((t) => t.status !== "completed").slice(0, 2);

  return (
    <section className="section-padding section-dark">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <ScrollReveal>
          <SectionHeading badge="Tournaments" title="Upcoming Events" description="Register your team for leagues and cups at Crossline." light />
        </ScrollReveal>
        ...
        <div className="text-center">
          <SectionCTA href="/tournaments" label="View Tournaments" />
        </div>
      </div>
    </section>
  );
